...
type BatchExchangeQuoteInput struct {
	Exchange string
}

func (client Client) BatchExchangeQuote(ctx context.Context, input BatchExchangeQuoteInput) ([]*QuoteOutput, error) {
