...
func (client Client) DowjonesConstituent(ctx context.Context) ([]*Constituent, error) {
	baseURL, err := url.Parse("https://financialmodelingprep.com/stable/dowjones-constituent")
	if err != nil {
